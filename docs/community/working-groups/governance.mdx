---
title: Governance Working Group Charter
...
The current Lead serves an interim term of no more than one year from charter approval. When a
Lead seat opens — the interim term ends, a Lead steps down, or the WG agrees to add a seat — the
WG selects future Leads as follows:
...
| Andreas Schlapbach       | TBD                                              | @schlpbch                                        |               | WG Member |
...
Monthly working sessions are agenda-driven: if no agenda items have been proposed by 48 hours
before a scheduled session, the Leads cancel it and announce the cancellation in `#governance-wg`.
Quarterly office hours are held regardless, since they are the open inbound surface and do not
require a pre-set agenda.
...
- "Meeting Notes - Governance WG" Discussions category live; meeting notes posted from every monthly working session that is held.
